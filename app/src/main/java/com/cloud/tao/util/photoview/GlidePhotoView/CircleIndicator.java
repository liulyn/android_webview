package com.cloud.tao.util.photoview.GlidePhotoView;
...
public class CircleIndicator extends LinearLayout implements OnPageChangeListener {
    ...
    private int mIndicatorBackgroundResId = R.drawable.checked_usb_close;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.checked_usb_open;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.checked_usb_open, R.drawable.checked_usb_open);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.checked_usb_open
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
...
//        addIndicator(mIndicatorBackgroundResId, mAnimationOut);
    ...
    private void createIndicators1(ViewPager viewPager) {
        ...
        for (int i = 0; i < count; i++) {
            if (count > 1) {
                if (i == 0 || i == count - 1) {
                    addIndicator1(mIndicatorUnselectedBackgroundResId, mAnimationIn).setVisibility(View.INVISIBLE);
                } else {
                    addIndicator1(mIndicatorUnselectedBackgroundResId, mAnimationIn);
                }
            }
        }
    }

    private View addIndicator1(@DrawableRes int backgroundDrawableId, Animator animator) {
        if (animator.isRunning()) animator.end();
