 ...
 * des: 商品详情弹出
 */
public class GoodsAttrDialog extends AppCompatDialog {
    ...
    public GoodsAttrDialog(Context context) {
        this(context, R.style.GoodsAttrDialogStyle);
    }

    public GoodsAttrDialog(Context context, int style) {
        super(context, style);
    ...
    public GoodsAttrDialog applyStyle(int styleId) {
    ...
    public GoodsAttrDialog cancelable(boolean cancelable){
        super.setCancelable(cancelable);
        mCancelable = cancelable;
        return this;
    }

    public GoodsAttrDialog canceledOnTouchOutside(boolean cancel){
     ...
     */
    public GoodsAttrDialog contentView(View v){
        mContentView = v;
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsAttrDialog contentView(int layoutId){
        if(layoutId == 0)
            return this;
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsAttrDialog heightParam(int height){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsAttrDialog inDuration(int duration){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsAttrDialog inInterpolator(Interpolator interpolator){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsAttrDialog outDuration(int duration){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsAttrDialog outInterpolator(Interpolator interpolator){
