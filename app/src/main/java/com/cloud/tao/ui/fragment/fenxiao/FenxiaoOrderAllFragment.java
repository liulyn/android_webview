 ...
 * des: 创业订单所有
 */
public class FenxiaoOrderAllFragment extends Fragment {

    private String myStoreId;
    private static final String TAG = FenxiaoOrderAllFragment.class.getSimpleName();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        dataBinding=new FenxiaoDataBinding(getActivity(),mLvcommissionList,TAG,myStoreId,"All");
    }
}
