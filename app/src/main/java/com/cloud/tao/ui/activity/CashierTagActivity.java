...
import com.cloud.tao.ui.fragment.cashier.BuyDetailTagFragment;
import com.cloud.tao.ui.fragment.cashier.BuyScoreTagFragment;
import com.cloud.tao.ui.fragment.cashier.CashierDetailTagFragment;
import com.cloud.tao.ui.fragment.cashier.CashierNeedTagFragment;
...
public class CashierTagActivity extends BaseNavBackActivity implements View.OnClickListener{
    ...
    private void initView() {
        mActivityMyOrderListBinding.tb.setTitleText("收银平台");
        ...
        mAllTextView.setText("购买云豆");
        mStayPayTextView.setText("购买明细");
        mStayGoodsTextView.setText("我要收银");
        mFinishedTextView.setText("收银明细");
        ...
        BuyScoreTagFragment tab1 = new BuyScoreTagFragment();
        BuyDetailTagFragment tab2 = new BuyDetailTagFragment();
        CashierNeedTagFragment tab3 = new CashierNeedTagFragment();
        CashierDetailTagFragment tab4 = new CashierDetailTagFragment();
        mDatas.add(tab1);
        mDatas.add(tab2);
        mDatas.add(tab3);
        mDatas.add(tab4);
