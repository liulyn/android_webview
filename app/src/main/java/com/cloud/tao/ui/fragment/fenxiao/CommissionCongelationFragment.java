 ...
 * des: 佣金待冻结
 */
public class CommissionCongelationFragment extends Fragment {

    private String myStoreId;
    private static final String TAG = CommissionCongelationFragment.class.getSimpleName();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        dataBinding=new CommissionDataBinding(getActivity(),mLvcommissionList,TAG,myStoreId,2);
    }
}
