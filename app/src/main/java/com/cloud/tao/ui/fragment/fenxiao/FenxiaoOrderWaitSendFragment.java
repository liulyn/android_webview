 ...
 * des: 创业订单待发货
 */
public class FenxiaoOrderWaitSendFragment extends Fragment {

    private String myStoreId;
    private static final String TAG = FenxiaoOrderWaitSendFragment.class.getSimpleName();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        dataBinding=new FenxiaoDataBinding(getActivity(),mLvcommissionList,TAG,myStoreId,"wait_send");
    }
}
