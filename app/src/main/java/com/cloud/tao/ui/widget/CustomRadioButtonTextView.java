...
public class CustomRadioButtonTextView extends TextView {
    ...
    public CustomRadioButtonTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initView(context, attrs);
    }

    public CustomRadioButtonTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public CustomRadioButtonTextView(Context context) {
        super(context);
