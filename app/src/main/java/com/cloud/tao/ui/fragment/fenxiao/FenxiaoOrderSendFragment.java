 ...
 * des: 创业订单已发货
 */
public class FenxiaoOrderSendFragment extends Fragment {

    private String myStoreId;
    private static final String TAG = FenxiaoOrderSendFragment.class.getSimpleName();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        dataBinding=new FenxiaoDataBinding(getActivity(),mLvcommissionList,TAG,myStoreId,"sended");
    }
}
