...
public class StayGoodsTagFragment extends Fragment {


	private static final String TAG = StayGoodsTagFragment.class.getSimpleName();
	View rootview;
	ListView orders;
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		mob =new MyOrderDataBinding(getActivity(),myRefreshListView,orders,"sended",TAG).loadData();
	}
}
