 ...
 * des: 佣金已结算
 */
public class CommissionConfirmedFragment extends Fragment {

    private String myStoreId;
    private static final String TAG = CommissionConfirmedFragment.class.getSimpleName();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        dataBinding=new CommissionDataBinding(getActivity(),mLvcommissionList,TAG,myStoreId,0);
    }
}
